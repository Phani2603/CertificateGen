...
import { Mail, Phone, Shield, Sparkles, Loader2, User } from "lucide-react"
    ...
    >
      ...
      >
        ...
        <div className="grid md:grid-cols-[320px,1fr] h-full w-full">
          <aside
            className="bg-neutral-950 text-white p-6 md:p-8 flex flex-col gap-6"
          >
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <Avatar className="h-20 w-20 ring-2 ring-neutral-800 shrink-0">
                  <AvatarImage src={formData.image} alt={formData.name} />
                  <AvatarFallback className="bg-neutral-800 text-white text-2xl">{initials}</AvatarFallback>
                </Avatar>
                <div className="flex-1 min-w-0 space-y-1.5">
                  <p className="text-xs text-neutral-400 uppercase tracking-wider">Signed in</p>
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex flex-wrap items-center gap-2">
                  <Badge variant="outline" className="border-neutral-800 text-neutral-300 bg-neutral-900 text-xs">
                    <Shield className="h-3 w-3 mr-1.5" /> Individual
                  </Badge>
                  {certCount !== null && (
                    <Badge variant="outline" className="border-neutral-800 text-neutral-300 bg-neutral-900 text-xs px-3 py-1.5">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <Button
                    variant="outline"
                    size="sm"
                    className="border-neutral-800 text-neutral-300 hover:bg-neutral-900 hover:text-white px-3 py-2 text-xs"
