            ...
            <div className="relative rounded-[26px] bg-white border border-slate-200 shadow-[0_18px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl p-5 md:p-8 lg:p-10">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 md:mb-8">
                <div className="flex items-center gap-4">
                  <div className={`flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-2xl border ${certificate.isValid
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2 p-1 bg-slate-100 rounded-lg w-full sm:w-auto">
                        <button
                          ...
                          className={`flex-1 px-4 py-2 rounded-md text-sm font-medium transition-colors ${downloadFormat === 'png'
                        ...
                        <button
                          ...
                          className={`flex-1 px-4 py-2 rounded-md text-sm font-medium transition-colors ${downloadFormat === 'pdf'
                              ? 'bg-white text-slate-900 shadow-sm'
                              : 'text-slate-600 hover:text-slate-900'
                            }`}
                        >
